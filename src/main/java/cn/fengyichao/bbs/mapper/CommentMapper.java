...
public interface CommentMapper {
    ...
    @Select("select id,parent_id,type,author,create_time,modified_time,like_count from comment")
    ...
    @Select("select id,parent_id,type,author,create_time,modified_time,like_count from comment where id = #{id}")
